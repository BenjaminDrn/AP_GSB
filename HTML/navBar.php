    ...
    <nav class="nav__container">
        ...
        <div class="nav__menu" id="nav-menu">
            <ul class="nav__list">
                ...
                <!--COMPES-RENDUS-->
                <li class="nav__item">
                    <a href="compterendu.php" class="nav__link">Comptes-rendus</a>
                </li>
                <!--VISITEURS-->
                <li class="nav__item">
                    <a href="visiteurs.php" class="nav__link">Visiteurs</a>
                </li>
                <!--PRATICIENS-->
                <li class="nav__item">
                    <a href="praticiens.php" class="nav__link">Praticiens</a>
                </li>
                <!--MEDICAMENTS-->
                <li class="nav__item">
                    <a href="medicaments.php" class="nav__link">Medicaments</a>
                </li>
                <li class="nav__item nav__leaveBtn toggle" id="leaveBtn1">
                    <a href="deconnexion.php">                    <button><i class='bx bx-power-off'></i>Déconnexion</button>
</a>
                </li>
            </ul>
